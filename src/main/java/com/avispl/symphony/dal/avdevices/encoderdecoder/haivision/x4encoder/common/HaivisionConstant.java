...
public class HaivisionConstant {
	...
	public static final String NO_SET_ERROR_AUDIO = "Unable to configure audio";
	public static final String NO_SET_ERROR_VIDEO = "Unable to set configure video";
	public static final String NO_SET_ERROR_STREAM = "Unable to set configure output stream";
	public static final String NO_SET_ERROR_CREATE_STREAM = "Unable to create output stream";
	public static final String ERR_SET_CONTROL = "Unable to execute control: ";
	public static final String ERR_RETRIEVE_SESSION = "Unable to retrieve authorization session: ";
	public static final String NO_CHANGE_ACTION_AUDIO_ERROR = "Unable to set state for the audio metric";
	public static final String NO_CHANGE_ACTION_VIDEO_ERROR = "Unable to set state for the video metric";
	public static final String NO_CHANGE_ACTION_STREAM_ERROR = "Unable to set state for the output stream metric";
